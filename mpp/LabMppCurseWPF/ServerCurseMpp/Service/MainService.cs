...
namespace LabMppCurseWPF.Service
{
	public static class MainService
	{
		...
		internal static void AdaugaRezervare(int idc, string numeAdaugare, string prenumeAdaugare, int numarLocuriAdaugare)
		{
			var cursaCurenta = ServiceCursa.FindOne(idc);
			...
			ServiceCursa.UpdateCursa(new Cursa(cursaCurenta.Id, cursaCurenta.IdDestinatie, cursaCurenta.DataPlecare, cursaCurenta.NrLocuriDisponibile - numarLocuriAdaugare, cursaCurenta.LocPlecare));

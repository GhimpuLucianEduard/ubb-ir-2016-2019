...
//
        ...
        /*
            normal
         */
        StudentService studentService = new StudentService(new StudentStreamFileRepo(new StudentValidator(),"studenti"));
        TemaService temaService = new TemaService(new TemaStreamFileRepo(new TemaValidator(),"teme"));
        NotaService notaService = new NotaService(new NotaStreamFileRepo(new NotaValidator(), "note"));

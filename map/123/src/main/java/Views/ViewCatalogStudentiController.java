...
public class ViewCatalogStudentiController implements Observer<Nota> {
    ...
    private void showNotaDialog(Nota nt) {
        ...
        loader.setLocation(getClass().getResource("/ViewCatalogDialogBox.fxml"));
        try {
    ...
    public void showHistory(ActionEvent actionEvent) {
        ...
        if(aux!=null){
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/ViewIstoricNote.fxml"));
            try {
                AnchorPane root = loader.load();
                Stage dialogStage = new Stage();
                dialogStage.initModality(Modality.WINDOW_MODAL);
    ...
    public void showNoteStudent() {
        ...
        if(aux!=null){
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/ViewCatalogNoteStudent.fxml"));
            try {
                AnchorPane root = loader.load();
                Stage dialogStage = new Stage();
                dialogStage.initModality(Modality.WINDOW_MODAL);
